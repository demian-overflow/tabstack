...
/**
 * Append a tab to the stack. Re-pushing a URL that is already stacked is a
 * no-op that refreshes the item's metadata rather than creating a duplicate,
 * so slot numbers never churn under you.
 *
